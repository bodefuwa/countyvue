...
class CountiesControllerTest < ActionController::TestCase
  ...
  test "should create county" do
    assert_difference('County.count') do
      post :create, county: { admin_office_address: @county.admin_office_address, name: @county.name, population: @county.population, state: @county.state, website: @county.website }
    end
  ...
  test "should update county" do
    patch :update, id: @county, county: { admin_office_address: @county.admin_office_address, name: @county.name, population: @county.population, state: @county.state, website: @county.website }
    assert_redirected_to county_path(assigns(:county))
  end
